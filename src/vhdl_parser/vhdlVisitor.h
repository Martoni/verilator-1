...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitSelected_name_part(vhdlParser::Selected_name_partContext *context) = 0;

    virtual antlrcpp::Any visitFunction_call_or_indexed_name_part(vhdlParser::Function_call_or_indexed_name_partContext *context) = 0;

    virtual antlrcpp::Any visitSlice_name_part(vhdlParser::Slice_name_partContext *context) = 0;

    virtual antlrcpp::Any visitAttribute_name_part(vhdlParser::Attribute_name_partContext *context) = 0;
    ...
    virtual antlrcpp::Any visitRange_decl(vhdlParser::Range_declContext *context) = 0;
