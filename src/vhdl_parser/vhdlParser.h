...
public:
  enum {
    ...
    NOISE = 54, NOR = 55, NOT = 56, NULL_TOKEN = 57, OF = 58, ON = 59, OPEN = 60, 
  ...
  enum {
    ...
    RuleSelected_name = 148, RuleSelected_name_part = 149, RuleFunction_call_or_indexed_name_part = 150, 
    RuleSlice_name_part = 151, RuleAttribute_name_part = 152, RuleNature_declaration = 153, 
    ...
    RuleQuantity_specification = 186, RuleRange_decl = 187, RuleExplicit_range = 188, 
  ...
  class Selected_name_partContext;
  class Function_call_or_indexed_name_partContext;
  class Slice_name_partContext;
  class Attribute_name_partContext;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Selected_name_partContext *selected_name_part();
    Function_call_or_indexed_name_partContext *function_call_or_indexed_name_part();
    Slice_name_partContext *slice_name_part();
    Attribute_name_partContext *attribute_name_part();
  ...
  class  Selected_name_partContext : public antlr4::ParserRuleContext {
  public:
    Selected_name_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> DOT();
    antlr4::tree::TerminalNode* DOT(size_t i);
    std::vector<SuffixContext *> suffix();
  ...
  class  Function_call_or_indexed_name_partContext : public antlr4::ParserRuleContext {
  public:
    Function_call_or_indexed_name_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LPAREN();
    Actual_parameter_partContext *actual_parameter_part();
    antlr4::tree::TerminalNode *RPAREN();
  ...
  class  Slice_name_partContext : public antlr4::ParserRuleContext {
  public:
    Slice_name_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LPAREN();
    Discrete_rangeContext *discrete_range();
    antlr4::tree::TerminalNode *RPAREN();
  ...
  class  Attribute_name_partContext : public antlr4::ParserRuleContext {
  public:
    Attribute_name_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Range_declContext : public antlr4::ParserRuleContext {
  public:
    Range_declContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Explicit_rangeContext *explicit_range();
    NameContext *name();
